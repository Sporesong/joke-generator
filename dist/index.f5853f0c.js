...
})({"5KLEE":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "bb3e80f7f5853f0c";
"use strict";
...
},{}],"1vuew":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _animalJokesService = require("./services/animalJokesService");
var _animalJokesServiceDefault = parcelHelpers.interopDefault(_animalJokesService);
var _nerdyJokesService = require("./services/nerdyJokesService");
var _nerdyJokesServiceDefault = parcelHelpers.interopDefault(_nerdyJokesService);
var _humorService = require("./services/humorService");
var _humorServiceDefault = parcelHelpers.interopDefault(_humorService);
let points = 0;
function init() {
    addEventListeners();
}
function addEventListeners() {
    ...
    const colorToggleBtn = document.querySelector(".colortoggleIcon");
...
const generateJoke = async ()=>{
    let selectedCategory = document.querySelector("#categoryPicker").value;
    if (selectedCategory == "Animal") {
        let joke = await (0, _animalJokesServiceDefault.default)();
        printHtml(joke);
    } else if (selectedCategory == "Nerdy") {
        let joke = await (0, _nerdyJokesServiceDefault.default)();
        printHtml(joke);
    } else {
        let humorJoke = await (0, _humorServiceDefault.default)(selectedCategory);
        printHtml(humorJoke);
    }
};
function printHtml(jokeText) {
    let div = document.querySelector(".jokebox");
...
function toggleColorMode() {
    ...
    if (colorTheme && colorModeIcon) {
        ...
        if (colorTheme.classList.contains("change")) colorModeIcon.textContent = "dark_mode";
        else colorModeIcon.textContent = "light_mode";
    }
}
init();

},{"./services/animalJokesService":"ajeeP","./services/nerdyJokesService":"dBtFQ","./services/humorService":"c9ec2","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ajeeP":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
const getAnimalJoke = async ()=>{
    console.log("running");
    const response = await (0, _axiosDefault.default).get("https://api.animal.io/jokes/random");
    const joke = response.data.value;
    console.log(response);
    return joke;
};
exports.default = getAnimalJoke;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dBtFQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
const getNerdyJoke = async ()=>{
    console.log("running");
    const response = await (0, _axiosDefault.default).get("https://api.nerdy.io/jokes/random");
    const joke = response.data.value;
    console.log(response);
    return joke;
};
exports.default = getNerdyJoke;

},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"c9ec2":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
...
exports.default = humorService;

},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["5KLEE","1vuew"], "1vuew", "parcelRequire9808")

//# sourceMappingURL=index.f5853f0c.js.map
